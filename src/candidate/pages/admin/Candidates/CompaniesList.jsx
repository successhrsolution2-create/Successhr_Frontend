            ...
            <tbody className="divide-y divide-slate-100">
              {paginated.map((company) => (
                <tr key={company._id} className="odd:bg-white even:bg-slate-50 hover:bg-sky-50/40">
                  <td className="px-4 py-2 font-semibold leading-5 text-slate-900">{company.companyName}</td>
                  <td className="px-4 py-2 leading-5 text-slate-700">{company.contactPersonName || '-'}</td>
