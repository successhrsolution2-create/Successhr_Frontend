  ...
  const filtered = useMemo(() => {
    ...
    return candidates
      ...
      const fields = [
        ...
        candidate.currentJobLocationMidcArea,
        candidate.currentJobLocationMidcAreaOther,
        ...(candidate.skills || [])
      ]
  ...
  const exportCsv = ({ fromDate: exportFromDate = '', toDate: exportToDate = '' } = {}) => {
    try {
      ...
      const headers = [
        ...
        'Expected Salary',
        'Notice Period',
        'Current Job Location (Taluka)',
        'Other Current Job Location (Taluka)',
        'Current Job Location (MIDC Area)',
        'Other MIDC Area',
      ...
      const rows = filteredData.map((item) => {
        ...
        return [
          ...
          item.currentJobLocationOther,
          item.currentJobLocationMidcArea,
          item.currentJobLocationMidcAreaOther,
          item.reasonForJobChange,
          familyDetails.fatherOccupation,
          familyDetails.motherOccupation,
          familyDetails.siblingName,
          familyDetails.siblingEducation,
          familyDetails.siblingMobileNumber,
          familyDetails.siblingGender,
          familyDetails.siblingCareerProfile,
          familyDetails.siblingStudyStandard,
          familyDetails.siblingStudyStandardOther,
          familyDetails.siblingCareerProfileOther,
          item.goalAim,
