...
export default function Dashboard() {
  ...
  const openRecent = (item) => {
    if (item.type === 'Candidate') {
      goTo('/candidate/admin/students', { search: item.candidateName, status: item.status })
      return
    }

    goTo('/candidate/admin/companies', { search: item.companyName, status: item.status })
  }
  ...
  const stats = [
    {
      ...
      icon: Users,
      color: 'text-sky-600',
      onClick: () => goTo('/candidate/admin/business-advisors')
    },
    {
      ...
      color: 'text-blue-600',
      onClick: () => goTo('/candidate/admin/students')
    },
    {
      ...
      onClick: () => goTo('/candidate/admin/companies')
    },
    {
      label: 'Pending',
      value: pending,
      ...
      onClick: () => goTo('/candidate/admin/references')
    },
    {
      ...
      onClick: () => goTo('/candidate/admin/commission')
    },
    {
      label: 'Paid Out',
      ...
      onClick: () => goTo('/candidate/admin/commission', { earningStatus: 'paid' })
    },
    {
      ...
      onClick: () => goTo('/candidate/admin/commission', { earningStatus: 'pending' })
    }
  ]
